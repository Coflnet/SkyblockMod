...
public class BinGuiManager {
    ...
    public static void openNewFlipGui(IChatComponent message, String[] lore, String auctionId) {
        Minecraft.getMinecraft().displayGuiScreen(new BinGuiNew(message, lore, auctionId));
    }
}
